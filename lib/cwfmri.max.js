...
var _MainScene = __webpack_require__(9);
...
var _active = __webpack_require__(10);

var _tutorial = __webpack_require__(6);

var _tryout = __webpack_require__(14);

var _running = __webpack_require__(13);

var _pause = __webpack_require__(12);

var _end = __webpack_require__(11);
  ...
  Promise.all([checkTaskDone, checkTaskEndNoComeback]).then(function (results) {
    ...
    if (result !== false) {
      ...
      switch (result.code) {
        ...
        default:
          // Start tutorial
          eventLevel = new _experimentJs.EventData(R.get.flags_levelDefined, stateManager.timeInMs, { level: 1 }); // TODO TAKE THAT BACk
...
var pauseTransition = function pauseTransition() {
  ...
  try {
    ...
    if (level <= 3) {
      ...
      var maxTransitionTime = 5 * 60 * 1000;
      var promise = stateManager.resolveOnKey({ except: null });
      var shouldtic = true;
