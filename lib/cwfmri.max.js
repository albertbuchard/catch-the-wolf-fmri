...
var imageToPreload = ['/assets/sprites/cross/predictionSquare.svg', '/assets/sprites/keyboard/fullsize_color_legend.png', '/assets/sprites/cross/fullSquare.svg', '/assets/sprites/cross/predictionSquareWithLoader.gif'];
    ...
    if (typeof state.currentTrialData !== 'undefined' && stateManager.get('subject_id')) {
      ...
      if (levelObject.dominantStructure) {
        ...
        if (index - 2 >= 0 && sequenceObject.fullSequence[index - 2] && sequenceObject.fullSequence[index - 1]) {
          var positionIndexInStructure = levelObject.dominantStructure.indexOf(sequenceObject.fullSequence[index - 2]);
...
var tryoutGoToNextPosition = function tryoutGoToNextPosition() {
  ...
  promise.then(function () {
    ...
    if (!state.tests.predictionTest.passed && state.tests.predictionTest.numberOfPrediction >= 3) {
